...
<main class="main">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item">Datos EQ</li>
    ...
    <div class="animated fadeIn">
      <div class="row">
        ...
        <div class="col-lg-3 col-md-3 pb-4 btn-group">
          <button class="btn" onClick="location.href = 'index.php?seccion=eqimport';" style="font-size:14px; color: #fff; background: #007f2d; text-align:left; margin-right:5px; border-radius:0px">
            <i class="fa fa-eye"></i> IMPORTAR DATOS A EQ
          </button>
        </div>
      </div>
      <!-- /.row-->
