<?php
 ...
 include('function.php');
	...
	$day=date('Y-m-d');
	$v=explode("-",$day);
	$filename="tablero_vendedores_".$v[2]."_".$v[1]."_".$v[0].".xls";
	$activo = 1;
   ...
   if (strstr($_SERVER["HTTP_USER_AGENT"], "MSIE")){
    ...
    while($row1 = $query1->fetch_assoc()){
      ...
      $rowbo = $querybo->fetch_assoc();
		...
		echo "\n<td class='tabla_dato' valign='top' style='border:1px solid #000000'>".$rowbo['ner_miss']."</td>";
	    echo "\n<td class='tabla_dato' valign='top' style='border:1px solid #000000'>".$rowbo['eq']."</td>";
	    echo "\n<td class='tabla_dato' valign='top' style='border:1px solid #000000'>".$rowbo['vol_s1']."</td>";
	    echo "\n<td class='tabla_dato' valign='top' style='border:1px solid #000000'>".$rowbo['vol_s2']."</td>";
	    echo "\n<td class='tabla_dato' valign='top' style='border:1px solid #000000'>".$rowbo['vol_s3']."</td>";
	    echo "\n<td class='tabla_dato' valign='top' style='border:1px solid #000000'>".$rowbo['vol_s4']."</td>";
	    echo "\n<td class='tabla_dato' valign='top' style='border:1px solid #000000'>".$rowbo['vol_heineken']."</td>";
		echo "\n<td class='tabla_dato' valign='top' style='border:1px solid #000000'>".$rowbo['productividad']."</td>";
		echo "\n<td class='tabla_dato' valign='top' style='border:1px solid #000000'>".$rowbo['vol_nr']."</td>";
		echo "\n<td class='tabla_dato' valign='top' style='border:1px solid #000000'>".$rowbo['efectividad']."</td>";
		echo "\n<td class='tabla_dato' valign='top' style='border:1px solid #000000'>".$rowbo['dentro_rango']."</td>";
		echo "\n<td class='tabla_dato' valign='top' style='border:1px solid #000000'>".$rowbo['fuera_frecuencia']."</td>";
		echo "\n<td class='tabla_dato' valign='top' style='border:1px solid #000000'>".$rowbo['cartera_vencida']."</td>";
		echo "\n<td class='tabla_dato' valign='top' style='border:1px solid #000000'>".$rowbo['ejecucion']."</td>";
		echo "\n<td class='tabla_dato' valign='top' style='border:1px solid #000000'>".$rowbo['prod_enfriadores']."</td>";
		echo "\n<td class='tabla_dato' valign='top' style='border:1px solid #000000'>".$rowbo['enf_sc']."</td>";  
		echo "\n<td class='tabla_dato' valign='top' style='border:1px solid #000000'>".$rowbo['prod1']."</td>"; 
		echo "\n<td class='tabla_dato' valign='top' style='border:1px solid #000000'>".$rowbo['prod1_cuota']."</td>"; 
		echo "\n<td class='tabla_dato' valign='top' style='border:1px solid #000000'>".$rowbo['prod2']."</td>";
		echo "\n<td class='tabla_dato' valign='top' style='border:1px solid #000000'>".$rowbo['prod2_cuota']."</td>";
		echo "\n<td class='tabla_dato' valign='top' style='border:1px solid #000000'>".$rowbo['prod3']."</td>";  
		echo "\n<td class='tabla_dato' valign='top' style='border:1px solid #000000'>".$rowbo['prod3_cuota']."</td>";
		echo "\n<td class='tabla_dato' valign='top' style='border:1px solid #000000'>".$rowbo['prod4']."</td>";
		echo "\n<td class='tabla_dato' valign='top' style='border:1px solid #000000'>".$rowbo['prod4_cuota']."</td>"; 
		echo "\n</tr>";	
	}
