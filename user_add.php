    ...
    <div class="animated fadeIn">
      <div class="row">
        ...
        <div class="col-lg-4 col-md-8 pb-4 btn-group">
          <button class="btn" onClick="location.href = 'index.php?seccion=userlist';" style="font-size:14px; color: #fff; background: #007f2d; text-align:left; margin-right:5px; border-radius:0px">
            <i class="fa fa-th-list"></i> LISTAR USUARIOS
          </button>
          ...
          <div class="card">
            ...
            <form id="useraddForm" method="post" enctype="multipart/form-data">
              <div class="card-body">
                  <div class="row">
                    <div class="col-sm-12">
                      <p style="color: #007f2d; font-size:1.2em">Por favor capture los siguientes datos para dar de alta a un usuario en el sistema (Todos los campos son obligatorios)</p>
                    </div>
                  </div> 
                  <div class="row">
                  ...
                  <div class="row" id="user_data">
                    <div class="form-group col-sm-6">
                      <div class="input-group">
                        <input class="form-control" id="username" type="text" name="usuario" placeholder="Usuario" required>
