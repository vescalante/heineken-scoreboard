<?php
 ...
 include('function.php');
	...
	$day=date('Y-m-d');
	$v=explode("-",$day);
	$filename="formato_imagen_exterior_".$v[2]."_".$v[1]."_".$v[0].".xls";
   ...
   if (strstr($_SERVER["HTTP_USER_AGENT"], "MSIE")){
	...
	echo "\n<td class='tabla_etiqueta' style='text-align:center; background:#007f2d;border:1px solid #000000; color: #ffffff'>Con imagen</td>";
	echo "\n<td class='tabla_etiqueta' style='text-align:center; background:#007f2d;border:1px solid #000000; color: #ffffff'>Sin imagen</td>";
